...
kubectl apply -f ~/llm-d/guides/inference-scheduling/pattern1/manifests/httproute-pattern1.yaml -n $NAMESPACE
```
...
- [llm-d Pattern 1 TPU Setup](https://github.com/llm-d/llm-d/blob/main/guides/inference-scheduling/pattern1/llm-d-pattern1-tpu-setup.md)
