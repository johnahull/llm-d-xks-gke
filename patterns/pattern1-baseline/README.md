...
kubectl apply -f patterns/pattern1-baseline/manifests/networkpolicy-default-deny.yaml
kubectl apply -f patterns/pattern1-baseline/manifests/networkpolicy-allow-gateway.yaml
kubectl apply -f patterns/pattern1-baseline/manifests/networkpolicy-allow-vllm-egress.yaml
