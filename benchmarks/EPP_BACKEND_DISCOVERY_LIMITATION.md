...
- **Pattern 2 GPU Documentation**: `patterns/pattern2-multimodel/docs/llm-d-gpu-setup.md`
- **Pattern 2 TPU (BBR approach)**: `patterns/pattern2-multimodel/docs/llm-d-tpu-setup.md`
