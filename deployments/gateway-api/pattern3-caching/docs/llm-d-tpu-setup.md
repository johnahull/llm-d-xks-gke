...
1. **`../llm-d/guides/inference-scheduling/ms-inference-scheduling/pattern3-tpu-overrides.yaml`** - **NEW** Pattern 3 TPU-specific configuration (Qwen2.5-3B-Instruct, 3 replicas, 4 chips per replica, 2x2 topology, TP=4, prefix caching enabled)
2. **`llm-d-pattern3-tpu-setup.md`** - **NEW** This documentation file
...
1. `../llm-d/guides/inference-scheduling/ms-inference-scheduling/values_tpu.yaml` - TPU base configuration
2. `../llm-d/guides/inference-scheduling/gaie-inference-scheduling/values.yaml` - Scheduler configuration with prefix-cache-scorer
